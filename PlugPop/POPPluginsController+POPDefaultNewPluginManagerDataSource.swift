...
extension POPPluginsController: POPDefaultNewPluginManagerDataSource {
    public func defaultNewPluginManager(_: POPDefaultNewPluginManager, pluginWithName name: String) -> Plugin? {
        return plugin(withName: name)
    }

    public func defaultNewPluginManager(_: POPDefaultNewPluginManager, pluginWithIdentifier identifier: String) -> Plugin? {
